...
// Generated on: 2024.03.09 at 11:43:08 PM MST 
//
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="choiceId" maxOccurs="unbounded" minOccurs="2"&gt;
 *                     &lt;simpleType&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(required = true)
    protected Question.Choices choices;
     ...
     * @return
     *     possible object is
     *     {@link Question.Choices }
     *     
     */
    public Question.Choices getChoices() {
        return choices;
    }
     ...
     *     
     */
    public void setChoices(Question.Choices value) {
        this.choices = value;
    }
        ...
        implements Serializable
    {
        ...
        private final static long serialVersionUID = 12343L;
        @XmlElement(required = true)
        protected List<BigInteger> choiceId;
         ...
         * 
         */
        public List<BigInteger> getChoiceId() {
            if (choiceId == null) {
                choiceId = new ArrayList<BigInteger>();
            }
