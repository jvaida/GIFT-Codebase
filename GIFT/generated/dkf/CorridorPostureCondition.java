...
@XmlRootElement(name = "CorridorPostureCondition")
public class CorridorPostureCondition implements Serializable
{

    private final static long serialVersionUID = 12343L;
    @XmlElement(required = true)
    protected Postures postures;
    @XmlElement(required = true)
    protected PathRef pathRef;
    protected TeamMemberRefs teamMemberRefs;

    /**
     * Gets the value of the postures property.
     * 
     * @return
     *     possible object is
     *     {@link Postures }
    ...
    /**
     * Sets the value of the postures property.
     * 
     * @param value
     *     allowed object is
     *     {@link Postures }
     *     
     */
    public void setPostures(Postures value) {
        this.postures = value;
    }
